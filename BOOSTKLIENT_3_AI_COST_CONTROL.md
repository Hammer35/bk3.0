...
- обнаружена недостаточная обоснованность ответа по заданным проверкам (не предполагаемая оценка успеха в Pinterest);
...
Качество оценивается по соответствию исходным данным и ограничениям, подтверждённости фактов, обозначению гипотез и объёму необходимых ручных исправлений. Результаты публикаций учитываются как наблюдения, а не как доказательство знания алгоритмов Pinterest или причин успеха. Проверки не заменяют отдельное одобрение каждого пина пользователем.
